...
public class addNewUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String fName=request.getSession().getAttribute("firstName").toString();
            String sName=request.getSession().getAttribute("sureName").toString();
            ...
            String query="INSERT INTO onlinetestswebsite.candidates " + "values('" + fName+"'," +"'"+ sName +"'," +"'"+ email+"'," +"'"+ pass +"')";
            statement = Con.createStatement();
            statement.executeUpdate(query);
            
            HttpSession session = request.getSession(true);
            session.setAttribute("ma", request.getSession().getAttribute("mail").toString());       
